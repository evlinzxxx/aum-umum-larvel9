    ...
    {{-- End Graph Inforamtion --}}
     ...
     <div style="margin-left: 80px; margin-right:80px;border: 0.1px solid;margin-top:25px">
      ...
      <div style="font-size: 10px; margin-top:-20px;padding:20px">
        Berdasarkan hasil pengolahan AUM UMUM, dapat disimpulan bahwa <span class="fw-bold text-danger"> {{$siswa->nama}} </span>memiliki masalah pada Bidang<span style="font-weight: bold; color:#eb5d1e"> {{$highest_kategori}} </span> Masalah terbanyak
        terdapat pada nomor <span style="font-size: 9px">{{$highest_masalah}}</span> dengan tingkat persentase masalah sebesar <span style="font-weight: bold; color:#ff0f0f"> {{$highest_percent}}% </span>.Setelah pengisian AUM UMUM ini, diharapkan untuk
