    ...
    {{-- End Graph Inforamtion --}}
     ...
     <div style="margin-left: 80px; margin-right:80px;border: 0.1px solid;margin-top:25px">
      ...
      <div style="font-size: 10px; margin-top:-20px;padding:20px">
        Berdasarkan hasil pengolahan AUM UMUM, dapat disimpulan bahwa <span class="fw-bold text-danger"> {{$siswa->nama}} </span>memiliki masalah pada Bidang<span style="font-weight: bold; color:#eb5d1e"> {{$kateg}} </span> Masalah terbanyak
