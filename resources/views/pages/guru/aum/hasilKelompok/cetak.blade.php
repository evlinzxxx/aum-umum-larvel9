...
{{-- Start Group Analysis --}}
  ...
  {{-- End Group Analysis --}}
    ...
    <div style="margin-top: -10px">
      ...
      <div style="margin-left: 80px; margin-right:80px;border: 0.1px solid;margin-top:15px">
        <h4 align="center" style="color:#1f77d5; margin-bottom:15px">Kesimpulan</h4>
        <div style="font-size: 10px; margin-top:-30px;padding:20px">
