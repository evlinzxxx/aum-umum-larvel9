...
<section style="margin-top: -50pt">
      ...
      <img style="width: 480; margin-left:35px; margin-top:20px" src="{{ $_POST['chart_inputt'] }}" alt="">
          ...
          <div  style="margin-left: 80px; margin-right:80px">
            <h4  allign="center" style="text-decoration-color: rgb(3, 48, 183)">Kesimpulan</h4>
            <div style="font-size: 10px; margin-top:-20px">
              Berdasarkan hasil pengolahan AUM UMUM, dapat disimpulan bahwa {{$siswa->nama}} memiliki masalah pada Bidang<span style="font-weight: bold; color:#eb5d1e"> {{$kateg}} </span> yaitu pada
              masalah nomor {{$masalah}} , dengan tingkat persentase masalah sebesar <span style="font-weight: bold; color:#eb5d1e"> {{$p}}% </span>.Setelah pengisian AUM UMUM ini, diharapkan untuk
