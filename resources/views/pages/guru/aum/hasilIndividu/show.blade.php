    ...
    <div class="container">
      ...
      <div class="card">
        <div class="title p-2 d-flex" style="background-color: #e8f6ffd1">
          ...
          <div class="p-4 px-4 flex">
            <div class="d-flex">
              <p class="mt-2" style="font-weight: semi-bold; font-size:13px">Nama Lengkap : {{ $siswa->nama }}</p>
            </div>
            <div class="d-flex">
              <p class="mt-2" style="font-weight: semi-bold; font-size:13px">NISN : {{ $siswa->nisn }}</p>
            </div>
            <div class="d-flex">
              <p class="mt-2" style="font-weight: semi-bold; font-size:13px">Kelas : {{ $siswa->tingkatan}}  {{ $siswa->jurusan}}  {{ $siswa->kelas}}</p>
            </div>
          </div>
        <div class="p-3 px-4 flex">
          <div class="d-flex">
            <p class="mt-3" style="font-weight: semi-bold; font-size:13px">Asal Sekolah : {{ $siswa->sekolah }}</p>
            </div>
            <div class="d-flex">
              <p class="mt-2" style="font-weight: semi-bold; font-size:13px">Jenis Kelamin : {{ $siswa->gender }}</p>
            </div>
          </div>
          <div class="d-flex">
            <p class="mt-4 p-2" style="font-weight: semi-bold; font-size:13px">Tanggal Pengisian : {{ $date }}</p>
          </div>
          <div class="mt-5 px-5" >
      ...
      <div class="card-body" style="padding-left:110px ; padding-right:110px ; margin-top: 20pt">
          ...
          <div class="row" style="margin-top: 10px">
            ...
            <div class="col-6" >
              <div class="card-body">
                <div id="chart" class="chart"  style="padding-right:50px">
                </div>
              </div>
            </div>
          </div>
